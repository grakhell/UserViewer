...
interface Repository {
    fun getRepositoryBranchesData(@NotNull userName:String, @NotNull repoName:String)
        :Observable<PagedList<GetBranchesInfoQuery.Node>>

    fun getRepositoryLanguageData( @NotNull userName:String, @NotNull repoName:String)
        :Observable<PagedList<GetLanguageInfoQuery.Node>>

    fun getRepositoryStargazersData( @NotNull userName:String, @NotNull repoName:String)
        :Observable<PagedList<GetStargazersInfoQuery.Node>>

    fun getRepositoryWatchersData( @NotNull userName:String, @NotNull repoName:String)
        :Observable<PagedList<GetWatchersInfoQuery.Node>>

    fun getRepositoryData( @NotNull userName:String, @NotNull repoName:String)
        :Observable<GetRepositoryInfoQuery.Repository?>

    fun getUserSearchResultData( @NotNull userName:String)
        :Observable<PagedList<GetUserSearchResultQuery.AsUser>>

    fun getUserOrganisationData( @NotNull userName: String)
        :Observable<PagedList<GetUserOrganisationInfoQuery.Node>>

    fun getUserRepositoryData( @NotNull userName: String)
        :Observable<PagedList<GetUserRepoInfoQuery.Node>>

    fun getUserStarredRepositoryData( @NotNull userName: String)
        :Observable<PagedList<GetUserStarredRepoInfoQuery.Node>>

    fun getUserInfoData( @NotNull userName: String)
