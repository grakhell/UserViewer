...
class RxObservableCreator @Inject constructor(private val gitApi: GitApiQueries){
    ...
    fun getUserSearchResultObservable(name:String, count:Int, cursor:String?):
   ...
   fun getStargazesInfoObservable(name:String, count:Int, cursor:String?, repositoryName:String):
    ...
    fun getWatcherInfoObservable(name:String, count:Int, cursor:String?, repositoryName:String):
