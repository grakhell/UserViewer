...
class RepositoryImpl @Inject constructor(private val rxBuilder: RxObservableCreator) : Repository {
    ...
    override fun getRepositoryBranchesData(
        userName: String,
        repoName: String
    ) =
    ...
    override fun getRepositoryLanguageData(
        userName: String,
        repoName: String
    ) =
    ...
    override fun getRepositoryStargazersData(
        userName: String,
        repoName: String
    ) =
    ...
    override fun getRepositoryWatchersData(
        userName: String,
        repoName: String
    ) =
