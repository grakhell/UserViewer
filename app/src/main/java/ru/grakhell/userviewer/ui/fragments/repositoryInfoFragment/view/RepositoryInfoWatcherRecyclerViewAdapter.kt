...
class RepositoryInfoWatcherRecyclerViewAdapter : PagedListAdapter<GetWatchersInfoQuery.Node,
    ...
    inner class ViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        fun bind(item: GetWatchersInfoQuery.Node?) {
    ...
    class CALLBACK : DiffUtil.ItemCallback<GetWatchersInfoQuery.Node>() {
        override fun areContentsTheSame(
            oldItem: GetWatchersInfoQuery.Node,
            newItem: GetWatchersInfoQuery.Node
        ): Boolean {
